...
from PySide6.QtGui import QDragEnterEvent, QDropEvent, QPalette, QColor, QFont, QAction, QIcon, QPixmap, QPainter
    ...
    def _handle_decrypt(self, file_path: Path):
        ...
        try:
            self._vault.decrypt_file(
                file_path,
                output_path,
                password=input_password  # 使用用户输入的密码
            )
